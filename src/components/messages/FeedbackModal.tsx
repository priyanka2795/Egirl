  ...
  >
    ...
    <div className='flex flex-col gap-6 px-8 py-6'>
        <div className='flex flex-col gap-3'>
            ...
            <div className='flex h-[100px] pl-4 pr-3 py-3 rounded-[14px] bg-white/[0.05] text-[#FFFFFF] text-[15px] font-normal leading-6'>The response seemed broken to me, it didn’t make sense</div>
        </div>
