  ...
  return (
    <div
      className={`refresh-icon-parent flex py-4 last:pb-0 ${
        chatName === 'Bubble chat' ? 'w-[52%]' : 'w-full'
      } ${
        chatName === 'Bubble chat' && name === 'You'
          ? 'rounded-br-0 ml-auto items-end justify-end rounded-bl-[10px] rounded-tl-[10px] rounded-tr-[10px] bg-[#5848BC]'
          : 'w-full items-start'
      }`}
    >
      {chatName === 'Bubble chat' && name === 'You' ? (
        ...
        {messageIcons ? (
          <>
            <div className='flex gap-[18px]'>
              <span
                className={`refresh-icon text-[16px] font-normal leading-6 ${
                  chatName === 'Bubble chat' ? 'w-[52%]' : 'w-full'
                } ${
                  chatName === 'Bubble chat' && name === 'You'
                    ? 'rounded-br-0 ml-auto items-end justify-end rounded-bl-[10px] rounded-tl-[10px] rounded-tr-[10px] bg-[#5848BC]'
              ...
              <div className=''>
                <div className='flex w-[78px] justify-end gap-3 opacity-0 group-hover:flex group-hover:opacity-100'>
                  ...
                  <div
                    ...
                    className='relative'
                  >
                    {name !== 'You' && <EmojiIcon className='cursor-pointer' />}
