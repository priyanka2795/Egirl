...
const SelectProfilePhoto = ({ CloseModal,UploadImgModal }: SelectProfilePhoto) => {
  ...
  return (
    <>
      <Modal
        open={true}
        modalClassName='flex flex-col w-full rounded-[20px] h-max bg-[#121212] max-w-[656px] pb-5'
        closeModal={() => CloseModal(false)}
        modalOverlayStyle='!bg-black/80'
      >
        <div className='flex items-center justify-between border-b border-[#FFFFFF14] p-6'>
          <h5 className='text-lg font-semibold'>Select profile photo</h5>
          <div
        ...
        <div className='flex flex-col gap-3 overflow-y-auto p-6 '>
          ...
          <div>
            ...
            <div className='grid grid-cols-2 gap-2' onClick={() => UploadImgModal()}>
              {allImages.map((item) => (
