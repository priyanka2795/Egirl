...
const BetaAccessBg = (props: JSX.IntrinsicAttributes & React.SVGProps<SVGSVGElement>) => (
  <svg
    width={630}
    height={800}
    fill="none"
  ...
  >
    ...
    <defs>
      <filter id="filter0_f_482_11266" x="-350.734" y="-39.4458" width="1263.33" height="1089.4" filterUnits="userSpaceOnUse" color-interpolation-filters="sRGB">
