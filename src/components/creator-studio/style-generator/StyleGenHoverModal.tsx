...
const StyleGenHoverModal = () => {
  return (
    <>
    <div className='absolute w-[169px] top-[657px] right-[11px] flex justify-center items-center px-3 py-[6px] rounded-[6px] bg-[#303030] text-white text-center text-[12px] font-normal leading-4'>
