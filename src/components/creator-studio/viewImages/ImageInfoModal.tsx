...
interface ImageInfoModalProp {
    setImageInfoPage: React.Dispatch<React.SetStateAction<boolean>> ;
}
...
const ImageInfoModal = ({setImageInfoPage}:ImageInfoModalProp) => {
  ...
  return (
    <Modal
        open={true}
        closeModal={() => setImageInfoPage(false)}
            ...
            <div className=' flex w-[445px] flex-col justify-between self-stretch p-6'>
              <div className='flex flex-col items-start self-stretch gap-5 '>
                <div className='flex items-center self-stretch gap-2'>
                  ...
                  <div onClick={() => setImageInfoPage(false)} className='cursor-pointer'>
