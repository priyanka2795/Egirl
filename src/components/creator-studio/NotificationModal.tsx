...
const NotificationModal = () => {
  ...
  return (
    <div className='absolute top-[72px] right-[92px] flex flex-col rounded-[14px] bg-[#1A1A1A] w-[484px]'>
        ...
        {notification.map((item) => {
            return(
                <div className={`flex justify-between p-6 border-l ${activeNotification === item.name ? 'border-l border-[#5848BC] bg-[#5848BC]/[0.08]' : 'border-b border-white/[0.08]'}`} onClick={() => {setActiveNotification(item.name)}}>
