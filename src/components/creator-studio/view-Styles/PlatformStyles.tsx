...
const PlatformStyles = () => {
  ...
  return (
            ...
            {allImages.map((item,index) => {
                return(
                    <div key={index} className='overflow-hidden flex flex-col rounded-[16px] bg-white/[0.05]'>
                        <Image onClick={() => {setPlatformStyleModal(true)}} src={item.image} alt={''} />
    ...
    {
        platformStyleModal && <FavoriteStyleModal closeModal={setPlatformStyleModal} component={'PlatformStyles'} />
    }
    </>
  )
}
