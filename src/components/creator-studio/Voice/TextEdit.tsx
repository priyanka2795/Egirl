...
const TextEdit = ({setTextEdit, editedText, setEditedText, setShowEditedText, voiceGenerations, activeIndex} : TextEditProp) => {
  return (
    <div className='flex gap-2'>
        <input type='text' defaultValue={(voiceGenerations[activeIndex].text)} onChange={(e) => {setEditedText(e.target.value)}} placeholder='Type something' className='bg-transparent border-none focus:ring-0 text-[14px] font-normal leading-[18px] text-[#979797] placeholder:text-[#979797] w-[258px] p-0'/>
