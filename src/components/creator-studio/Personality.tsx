        ...
        <div className='w-full flex flex-col gap-4 p-6 rounded-[14px] bg-[#121212]'>
          ...
          <div className='flex w-full gap-4'>
            ...
            <div className='w-1/2 flex flex-col gap-[6px]'>
              ...
              <textarea className='resize-none border-none h-[135px] py-3 pl-4 pr-3 rounded-[14px] bg-white/[0.05] text-[#979797] text-[15px] font-normal leading-6 focus:ring-0' placeholder="Enter a world description here..."></textarea>
            </div>
          </div>
        </div>
      </div>
