...
const Success = () => {
  return (
    <div className='flex mt-5'>
        <div className='border-r border-white/[0.08] bg-[#121212] w-full h-max justify-between'>
            <div className='px-8 pt-[18px] pb-[14px] border-b border-white/[0.08]'>
        ...
        <div className='relative flex flex-col gap-4 p-4'>
            ...
            <div className='absolute flex p-2 rounded-full bg-white/[0.05]'>
