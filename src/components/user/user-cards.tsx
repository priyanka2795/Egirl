...
const allNoStatsData: Readonly<NoStatsData> = {
  ...
  followers: {
    ...
    imageData: { src: '/assets/no-followers.webp', alt: 'No followers' },
    description:
