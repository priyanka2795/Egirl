  ...
  return (
    ...
    <div className={`px-8 py-[35px] bg-[${bgImage}] flex justify-between`}>
      ...
      <div className='p-[54px]'>
        <div className='flex flex-col gap-8 p-10 rounded-[40px] bg-[#070707] w-[500px]'>
          ...
          <div className='flex flex-col gap-4'>
            ...
            <div className='flex flex-col gap-[6px]'>
              ...
              <input type='email' placeholder='example@gmail.com' className='px-4 py-3 flex rounded-[14px] bg-white/[0.05] text-[#979797] text-[15px] font-normal leading-6 placeholder:text-[#979797] focus:ring-0 border-none bg-transparent'/>
            </div>
            <div className='flex flex-col gap-3'>
              <div className='flex flex-col gap-[6px]'>
                <div className='text-[#979797] text-[13px] font-semibold leading-[18px]'>Password</div>
                <input type='password' placeholder='Password' className='px-4 py-3 flex rounded-[14px] bg-white/[0.05] text-[#979797] text-[15px] font-normal leading-6 placeholder:text-[#979797] focus:ring-0 border-none bg-transparent'/>
              </div>
